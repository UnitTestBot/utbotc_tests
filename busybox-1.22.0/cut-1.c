...
long symbols_long[100];
unsigned long symbols_ulong[100];
int symbols_int[100];
unsigned int symbols_uint[100];
char symbols_char[100];
short symbols_short[100];

long __VERIFIER_nondet_long(void) {
  static unsigned cnt = 0;
  return symbols_long[cnt++];
}
unsigned long __VERIFIER_nondet_ulong(void) {
  static unsigned cnt = 0;
  return symbols_ulong[cnt++];
}
unsigned long __VERIFIER_nondet_int(void) {
  static unsigned cnt = 0;
  return symbols_int[cnt++];
}
unsigned int __VERIFIER_nondet_uint(void) {
  static unsigned cnt = 0;
  return symbols_uint[cnt++];
}
char __VERIFIER_nondet_char(void) {
  static unsigned cnt = 0;
  return symbols_char[cnt++];
}
short __VERIFIER_nondet_short(void) {
  static unsigned cnt = 0;
  return symbols_short[cnt++];
}
...
static inline unsigned int bb_strtoui(const char *str, char **end,
                                      signed int b);
...
static void cut_file(struct _IO_FILE *file, char delim,
                     struct cut_list *cut_lists, unsigned int nlists);
...
static signed long int full_write(signed int fd, const void *buf,
...
static signed long int safe_write(signed int fd, const void *buf,
                                  unsigned long int count);
// file include/libbb.h line 858
static signed int xatoi_positive(const char *numstr);
// file include/xatonum.h line 99
static unsigned int xatou_range(const char *numstr, unsigned int lower,
                                unsigned int upper);
...
static void *xrealloc_vector_helper(void *vector, unsigned int sizeof_and_shift,
                                    signed int idx);
// file libbb/xatonum_template.c line 19
static unsigned int xstrtou_range_sfx(const char *numstr, signed int base,
                                      unsigned int lower, unsigned int upper,
                                      struct suffix_mult *suffixes);
...
static const char bb_msg_memory_exhausted[14l] = {
    (const char)111, (const char)117, (const char)116, (const char)32,
    (const char)111, (const char)102, (const char)32,  (const char)109,
    (const char)101, (const char)109, (const char)111, (const char)114,
    (const char)121, (const char)0};
// file libbb/messages.c line 33
static const char bb_msg_standard_input[15l] = {
    (const char)115, (const char)116, (const char)97,  (const char)110,
    (const char)100, (const char)97,  (const char)114, (const char)100,
    (const char)32,  (const char)105, (const char)110, (const char)112,
    (const char)117, (const char)116, (const char)0};
// file libbb/messages.c line 34
static const char bb_msg_standard_output[16l] = {
    (const char)115, (const char)116, (const char)97,  (const char)110,
    (const char)100, (const char)97,  (const char)114, (const char)100,
    (const char)32,  (const char)111, (const char)117, (const char)116,
    (const char)112, (const char)117, (const char)116, (const char)0};
// file libbb/getopt32.c line 320
static struct option bb_null_long_options[1l] = {{.name = (const char *)NULL,
                                                  .has_arg = 0,
                                                  .flag = (signed int *)NULL,
                                                  .val = 0}};
...
static const char optstring[11l] = {
    (const char)98,  (const char)58,  (const char)99,  (const char)58,
    (const char)102, (const char)58,  (const char)100, (const char)58,
    (const char)115, (const char)110, (const char)0};
...
static char *bb_get_chunk_from_file(struct _IO_FILE *file, signed int *end) {
  ...
  do {
    ...
    if ((255u & idx) == 0u) {
      return_value_xrealloc$1 = xrealloc(
          (void *)linebuf, (unsigned long int)(idx + (unsigned int)256));
  ...
  if (!(linebuf == ((char *)NULL))) {
    ...
    return_value_xrealloc$3 =
        xrealloc((void *)linebuf, (unsigned long int)(idx + (unsigned int)1));
...
// file include/libbb.h line 1084
static void bb_simple_perror_msg(const char *s) { bb_perror_msg("%s", s); }
...
static void bb_verror_msg(const char *s, va_list p, const char *strerr) {
  ...
  return_value_realloc$5 =
      realloc((void *)msg, (unsigned long int)(applet_len + used + strerr_len +
                                               msgeol_len + 3));
  ...
  if (msg1 == ((char *)NULL)) {
    ...
    msg = msg1;
    memmove((void *)(msg + (signed long int)applet_len), (const void *)msg,
    ...
    if (!((3u & option_mask32) == 0u))
      ...
      while (!(spos >= (signed int)linenum)) {
        ...
        if (!((cut_lists + (signed long int)cl_pos)->endpos >= spos))
          ...
          tmp_if_expr$3 = ((cut_lists + (signed long int)cl_pos)->endpos == -1
                               ? (signed int)(1 != 0)
                               : (signed int)(0 != 0)) != 0;
        }
      ...
      for (; !(line == ((char *)NULL)) && !(cl_pos >= nlists);
           cl_pos = cl_pos + 1u) {
        ...
        if ((cut_lists + (signed long int)cl_pos)->endpos >= spos &&
            !(line == ((char *)NULL)))
          tmp_if_expr$5 = ((cut_lists + (signed long int)cl_pos)->endpos != -1
                               ? (signed int)(1 != 0)
                               : (signed int)(0 != 0)) != 0;
...
signed int __main(signed int argc, char **argv) {
  ...
  if ((4u & opt) == 0u) {
    static const char _op_on_field[31l] = {
        (const char)32,  (const char)111, (const char)110, (const char)108,
        (const char)121, (const char)32,  (const char)119, (const char)104,
        (const char)101, (const char)110, (const char)32,  (const char)111,
        (const char)112, (const char)101, (const char)114, (const char)97,
        (const char)116, (const char)105, (const char)110, (const char)103,
        (const char)32,  (const char)111, (const char)110, (const char)32,
        (const char)102, (const char)105, (const char)101, (const char)108,
        (const char)100, (const char)115, (const char)0};
    if (!((16u & opt) == 0u))
      bb_error_msg_and_die("suppressing non-delimited lines makes sense%s",
                           (const void *)_op_on_field);

    if (!((signed int)delim == 9))
      bb_error_msg_and_die("a delimiter may be specified%s",
                           (const void *)_op_on_field);
  }
  ...
  do {
    ...
    if (!((signed int)*ltok == 0)) {
      ...
      return_value_xrealloc_vector_helper$11 = xrealloc_vector_helper(
          (void *)cut_lists,
          (unsigned int)((sizeof(struct cut_list) /*8ul*/ << 8) +
                         (unsigned long int)4),
          (signed int)nlists);
  ...
  qsort((void *)cut_lists, (unsigned long int)nlists,
        sizeof(struct cut_list) /*8ul*/, cmpfunc);
  signed int retval = 0;
  ...
  // fflush_stdout_and_exit(retval); -- invokes exit() and would thus leak
  // memory
  fflush(stdout);
  return retval;
}
...
static struct _IO_FILE *fopen_or_warn_stdin(const char *filename) {
  ...
  if (!(filename == bb_msg_standard_input)) {
    if (!((signed int)*filename == 45))
      ...
      tmp_if_expr$1 = ((signed int)filename[(signed long int)1] != 0
                           ? (signed int)(1 != 0)
                           : (signed int)(0 != 0)) != 0;
...
static unsigned int getopt32(char **argv, const char *applet_opts, ...) {
  ...
  if ((signed int)*s == 43)
    ...
    tmp_if_expr$1 = ((signed int)*s == 45 ? (signed int)(1 != 0)
                                          : (signed int)(0 != 0)) != 0;
  if (!(tmp_if_expr$1 == (_Bool)0))
    s = s + 1l;
  ...
  if (!(applet_long_options == ((const char *)NULL))) {
    ...
    while (!((signed int)*optstr == 0)) {
      ...
      optstr = optstr +
               (signed long int)(return_value_strlen$2 + (unsigned long int)3);
      count = count + 1u;
    }
    void *return_value___builtin_alloca$3;
    return_value___builtin_alloca$3 = __builtin_alloca(
        (unsigned long int)count * sizeof(struct option) /*32ul*/);
    long_options = (struct option *)return_value___builtin_alloca$3;
    memset((void *)long_options, 0,
           (unsigned long int)count * sizeof(struct option) /*32ul*/);
    i = (unsigned int)0;
    optstr = applet_long_options;
    do {
      ...
      optstr = optstr +
               (signed long int)(return_value_strlen$4 + (unsigned long int)1);
      tmp_post$5 = optstr;
      optstr = optstr + 1l;
      (long_options + (signed long int)i)->has_arg =
          (signed int)(unsigned char)*tmp_post$5;
      tmp_post$6 = optstr;
      optstr = optstr + 1l;
      (long_options + (signed long int)i)->val =
          (signed int)(unsigned char)*tmp_post$6;
      i = i + 1u;
    } while ((_Bool)1);
    l_o = long_options;
  ...
  while ((_Bool)1) {
    if (!(s == ((const unsigned char *)NULL)))
      tmp_if_expr$7 = ((signed int)*s != 0 ? (signed int)(1 != 0)
                                           : (signed int)(0 != 0)) != 0;
        ...
        __CPROVER_DUMP_L36:;
          if (c == 43) {
            if ((signed int)*(2l + s) == 58)
              ...
              tmp_if_expr$8 = ((signed int)s[(signed long int)2] == 0
                                   ? (signed int)(1 != 0)
                                   : (signed int)(0 != 0)) != 0;
          ...
          __CPROVER_DUMP_L39:;
            ...
            if (c == 45) {
              if ((signed int)*(2l + s) == 58)
                ...
                tmp_if_expr$9 = ((signed int)s[(signed long int)2] == 0
                                     ? (signed int)(1 != 0)
                                     : (signed int)(0 != 0)) != 0;
            ...
            __CPROVER_DUMP_L44:;
              ...
              while ((_Bool)1) {
                if (!((signed int)*s == 0))
                  tmp_if_expr$10 =
                      ((signed int)*s != 58 ? (signed int)(1 != 0)
                                            : (signed int)(0 != 0)) != 0;
                ...
                pair_switch = &pair->
                  ...
                  on_off = complementary;
                  for (; !((signed int)on_off->opt_char == 0);
                       on_off = on_off + 1l)
                    if (on_off->opt_char == *s) {
    ...
    for (; !(*pargv == ((char *)NULL)); pargv = pargv + 1l) {
      if (!((signed int)*(*pargv) == 45)) {
        if (!((signed int)*(*pargv) == 0)) {
          ...
          return_value_xmalloc$12 =
              xmalloc(return_value_strlen$11 + (unsigned long int)2);
  ...
  do {
    ...
    if (!(optarg == ((char *)NULL))) {
      ...
      else if ((signed int)on_off->param_type == 2) {
        signed int return_value_xatoi_positive$13;
        return_value_xatoi_positive$13 = xatoi_positive(optarg);
        *((unsigned int *)on_off->optarg) =
            (unsigned int)return_value_xatoi_positive$13;
      }

      else if (!(on_off->optarg == ((void **)NULL)))
...
// file include/libbb.h line 1045
static void llist_add_to_end(struct llist_t **list_head, void *data) {
  for (; !(*list_head == ((struct llist_t *)NULL));
...
static signed long int safe_write(signed int fd, const void *buf,
  ...
  do {
    ...
    if (n < 0l)
      tmp_if_expr$1 =
          (*bb_errno == 4 ? (signed int)(1 != 0) : (signed int)(0 != 0)) != 0;
...
static signed int xatoi_positive(const char *numstr) {
  ...
  return_value_xatou_range$1 =
      xatou_range(numstr, (unsigned int)0, (unsigned int)2147483647);
...
static unsigned int xatou_range(const char *numstr, unsigned int lower,
  ...
  return_value_xstrtou_range_sfx$1 =
      xstrtou_range_sfx(numstr, 10, lower, upper, (struct suffix_mult *)NULL);
...
static void xfunc_die(void) {
  if (!(die_sleep == 0)) {
    if (die_sleep < 0)
      longjmp(die_jmp, (signed int)xfunc_error_retval != 0
                           ? (signed int)xfunc_error_retval
                           : -2222);
...
static void *xrealloc_vector_helper(void *vector, unsigned int sizeof_and_shift,
  ...
  if ((-1 + mask & idx) == 0) {
    ...
    vector =
        xrealloc(vector, (unsigned long int)(sizeof_and_shift *
                                             (unsigned int)(idx + mask + 1)));
    memset((void *)((char *)vector +
                    (signed long int)(sizeof_and_shift * (unsigned int)idx)),
           0, (unsigned long int)(sizeof_and_shift * (unsigned int)(mask + 1)));
  }
...
static unsigned int xstrtou_range_sfx(const char *numstr, signed int base,
  ...
  if ((signed int)*numstr == 45)
    ...
    tmp_if_expr$1 = ((signed int)*numstr == 43 ? (signed int)(1 != 0)
                                               : (signed int)(0 != 0)) != 0;
  _Bool tmp_if_expr$3;
  ...
  if (!(tmp_if_expr$1 == (_Bool)0))
    ...
    tmp_statement_expression$2 =
        (signed int)bb__isspace == 32 - 9 || (signed int)bb__isspace <= 13 - 9;
    tmp_if_expr$3 =
        (tmp_statement_expression$2 != (_Bool)0 ? (signed int)(1 != 0)
                                                : (signed int)(0 != 0)) != 0;
  }
    ...
    if (!(numstr == e)) {
      if (*bb_errno == 0) {
        *bb_errno = old_errno;
        ...
        range:;
          bb_error_msg_and_die("number %s is not in %llu..%llu range", numstr,
...
int _IO_getc(struct _IO_FILE *stream) { return fgetc(stream); }
...
int getopt(int argc, char *const argv[], const char *optstring) {
  ...
  assume_abort_if_not(opt_index < strlen(optstring) &&
                      optstring[opt_index] != ':');
...
int vasprintf(char **ptr, const char *fmt, va_list ap) {
  ...
  (void)ap;
  int no_format = 1;
  for (size_t s = 0; s < strlen(fmt); s++)
    if (fmt[s] == '%') {
      no_format = 0;
      break;
    }
  if (no_format) {
    *ptr = malloc(strlen(fmt));
    strcpy(*ptr, fmt);
    return strlen(fmt);
  }
