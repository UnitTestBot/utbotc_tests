...
void reach_error() {
  ((void)sizeof((0) ? 1 : 0), __extension__({
     if (0)
       ...
       __assert_fail(
           "0",
           "linux-3.8-rc1-32_7a-drivers--media--dvb-frontends--stv090x.ko-ldv_"
           "main0_sequence_infinite_withcheck_stateful.cil.out.c",
           3, __extension__ __PRETTY_FUNCTION__);
   }));
}
...
enum fe_sec_tone_mode { SEC_TONE_ON = 0, SEC_TONE_OFF = 1 };
typedef enum fe_sec_tone_mode fe_sec_tone_mode_t;
enum fe_sec_mini_cmd { SEC_MINI_A = 0, SEC_MINI_B = 1 };
...
enum fe_pilot { PILOT_ON = 0, PILOT_OFF = 1, PILOT_AUTO = 2 };
...
struct dentry_operations {
  ...
  int (*d_compare)(struct dentry const *, struct inode const *,
                   struct dentry const *, struct inode const *, unsigned int,
...
struct file_operations {
  ...
  int (*readdir)(struct file *, void *,
                 int (*)(void *, char const *, int, loff_t, u64, unsigned int));
...
struct dvb_tuner_ops {
  ...
  int (*set_state)(struct dvb_frontend *, enum tuner_param,
                   struct tuner_state *);
  int (*get_state)(struct dvb_frontend *, enum tuner_param,
                   struct tuner_state *);
};
...
struct dvb_frontend_ops {
  ...
  int (*get_tune_settings)(struct dvb_frontend *,
                           struct dvb_frontend_tune_settings *);
  ...
  int (*diseqc_send_master_cmd)(struct dvb_frontend *,
                                struct dvb_diseqc_master_cmd *);
  int (*diseqc_recv_slave_reply)(struct dvb_frontend *,
                                 struct dvb_diseqc_slave_reply *);
...
enum tuner_mode { TUNER_SLEEP = 1, TUNER_WAKE = 2 };
enum stv090x_demodulator {
  STV090x_DEMODULATOR_0 = 1,
  STV090x_DEMODULATOR_1 = 2
};
enum stv090x_device { STV0903 = 0, STV0900 = 1 };
enum stv090x_mode { STV090x_DUAL = 0, STV090x_SINGLE = 1 };
enum stv090x_clkmode { STV090x_CLK_INT = 0, STV090x_CLK_EXT = 2 };
enum stv090x_i2crpt {
...
enum stv090x_adc_range { STV090x_ADC_2Vpp = 0, STV090x_ADC_1Vpp = 1 };
...
enum stv090x_frame { STV090x_LONG_FRAME = 0, STV090x_SHORT_FRAME = 1 };
enum stv090x_pilot { STV090x_PILOTS_OFF = 0, STV090x_PILOTS_ON = 1 };
...
struct dvb_frontend *stv090x_attach(struct stv090x_config const *config,
                                    struct i2c_adapter *i2c,
                                    enum stv090x_demodulator demod);
...
static struct stv090x_dev *find_dev(struct i2c_adapter *i2c_adap, u8 i2c_addr) {
  ...
  ldv_24149:;
    if ((unsigned long)temp_dev != (unsigned long)((struct stv090x_dev *)0) &&
        ((unsigned long)(temp_dev->internal)->i2c_adap !=
             (unsigned long)i2c_adap ||
         (int)(temp_dev->internal)->i2c_addr != (int)i2c_addr)) {
      goto ldv_24148;
    } else {
    }
    return (temp_dev);
...
static struct stv090x_dev *append_internal(struct stv090x_internal *internal) {
  ...
  void *tmp;
  {
    ...
    if ((unsigned long)new_dev != (unsigned long)((struct stv090x_dev *)0)) {
      ...
      new_dev->next_dev = 0;
      if ((unsigned long)stv090x_first_dev ==
          (unsigned long)((struct stv090x_dev *)0)) {
      ...
      ldv_24164:
        temp_dev = temp_dev->next_dev;
      ldv_24165:;
        if ((unsigned long)temp_dev->next_dev !=
            (unsigned long)((struct stv090x_dev *)0)) {
          goto ldv_24164;
        } else {
        }
...
static struct stv090x_tab const stv090x_s1cn_tab[52U] = {
    {0, 8917},   {5, 8801},   {10, 8667},  {15, 8522},  {20, 8355},
    {25, 8175},  {30, 7979},  {35, 7763},  {40, 7530},  {45, 7282},
    {50, 7026},  {55, 6781},  {60, 6514},  {65, 6241},  {70, 5965},
    {75, 5690},  {80, 5424},  {85, 5161},  {90, 4902},  {95, 4654},
    {100, 4417}, {105, 4186}, {110, 3968}, {115, 3757}, {120, 3558},
    {125, 3366}, {130, 3185}, {135, 3012}, {140, 2850}, {145, 2698},
    {150, 2550}, {160, 2283}, {170, 2042}, {180, 1827}, {190, 1636},
    {200, 1466}, {210, 1315}, {220, 1181}, {230, 1064}, {240, 960},
    {250, 869},  {260, 792},  {270, 724},  {280, 665},  {290, 616},
    {300, 573},  {310, 537},  {320, 507},  {330, 483},  {400, 398},
    {450, 381},  {500, 377}};
static struct stv090x_tab const stv090x_s2cn_tab[55U] = {
    {-30, 13348}, {-20, 12640}, {-10, 11883}, {0, 11101},  {5, 10718},
    {10, 10339},  {15, 9947},   {20, 9552},   {25, 9183},  {30, 8799},
    {35, 8422},   {40, 8062},   {45, 7707},   {50, 7353},  {55, 7025},
    {60, 6684},   {65, 6331},   {70, 6036},   {75, 5727},  {80, 5437},
    {85, 5164},   {90, 4902},   {95, 4653},   {100, 4408}, {105, 4187},
    {110, 3961},  {115, 3751},  {120, 3558},  {125, 3368}, {130, 3191},
    {135, 3017},  {140, 2862},  {145, 2710},  {150, 2565}, {160, 2300},
    {170, 2058},  {180, 1849},  {190, 1663},  {200, 1495}, {210, 1349},
    {220, 1222},  {230, 1110},  {240, 1011},  {250, 925},  {260, 853},
    {270, 789},   {280, 734},   {290, 690},   {300, 650},  {310, 619},
    {320, 593},   {330, 571},   {400, 498},   {450, 484},  {500, 481}};
static struct stv090x_tab const stv090x_rf_tab[14U] = {
    {-5, 51873},  {-10, 49705}, {-15, 47880}, {-20, 46268}, {-25, 44378},
    {-30, 41624}, {-35, 39080}, {-40, 33673}, {-45, 22974}, {-50, 14868},
    {-55, 11537}, {-60, 8461},  {-65, 41295}, {-70, 1962}};
static struct stv090x_reg stv0900_initval[161U] = {
    {61724U, 0U},   {61725U, 255U}, {61778U, 17U},  {61782U, 19U},
    {63088U, 20U},  {61921U, 33U},  {61923U, 33U},  {61840U, 34U},
    {61849U, 192U}, {61850U, 192U}, {61841U, 0U},   {61972U, 249U},
    {61968U, 8U},   {61982U, 196U}, {62013U, 237U}, {62015U, 208U},
    {62016U, 184U}, {62032U, 210U}, {62035U, 32U},  {62544U, 210U},
    {62036U, 0U},   {62368U, 136U}, {62370U, 58U},  {62376U, 0U},
    {62386U, 16U},  {62360U, 53U},  {62364U, 193U}, {62017U, 248U},
    {61953U, 28U},  {61975U, 32U},  {61984U, 112U}, {61985U, 136U},
    {61996U, 91U},  {61997U, 56U},  {62008U, 228U}, {62009U, 26U},
    {62010U, 9U},   {62014U, 8U},   {62040U, 193U}, {62037U, 240U},
    {62038U, 112U}, {62041U, 88U},  {62042U, 1U},   {62096U, 38U},
    {62108U, 134U}, {62109U, 134U}, {62208U, 119U}, {62209U, 133U},
    {62210U, 119U}, {62324U, 32U},  {61973U, 59U},  {62128U, 255U},
    {62129U, 255U}, {62130U, 255U}, {62131U, 255U}, {62132U, 255U},
    {62133U, 255U}, {62134U, 255U}, {62135U, 204U}, {62136U, 204U},
    {62137U, 204U}, {62138U, 204U}, {62139U, 204U}, {62140U, 204U},
    {62141U, 204U}, {62142U, 204U}, {62143U, 207U}, {61856U, 34U},
    {61865U, 192U}, {61866U, 192U}, {61857U, 0U},   {62484U, 249U},
    {62480U, 8U},   {62494U, 196U}, {62487U, 32U},  {62525U, 237U},
    {62527U, 208U}, {62528U, 184U}, {62544U, 210U}, {62547U, 32U},
    {62548U, 0U},   {62549U, 240U}, {62550U, 112U}, {62836U, 32U},
    {62880U, 136U}, {62882U, 58U},  {62888U, 0U},   {62898U, 16U},
    {62872U, 53U},  {62876U, 193U}, {62529U, 248U}, {62465U, 28U},
    {62496U, 112U}, {62497U, 136U}, {62508U, 91U},  {62509U, 56U},
    {62520U, 228U}, {62521U, 26U},  {62522U, 9U},   {62526U, 8U},
    {62552U, 193U}, {62553U, 88U},  {62554U, 1U},   {62608U, 38U},
    {62620U, 134U}, {62621U, 134U}, {62720U, 119U}, {62721U, 133U},
    {62722U, 119U}, {62485U, 59U},  {62640U, 255U}, {62641U, 255U},
    {62642U, 255U}, {62643U, 255U}, {62644U, 255U}, {62645U, 255U},
    {62646U, 255U}, {62647U, 204U}, {62648U, 204U}, {62649U, 204U},
    {62650U, 204U}, {62651U, 204U}, {62652U, 204U}, {62653U, 204U},
    {62654U, 204U}, {62655U, 207U}, {64134U, 29U},  {64003U, 55U},
    {64004U, 41U},  {64005U, 55U},  {64006U, 51U},  {64007U, 49U},
    {64008U, 47U},  {64009U, 57U},  {64010U, 58U},  {64011U, 41U},
    {64012U, 55U},  {64013U, 51U},  {64014U, 47U},  {64015U, 57U},
    {64016U, 58U},  {64063U, 4U},   {64067U, 12U},  {64068U, 15U},
    {64069U, 17U},  {64070U, 20U},  {64071U, 23U},  {64072U, 25U},
    {64073U, 32U},  {64074U, 33U},  {64075U, 13U},  {64076U, 15U},
    {64077U, 19U},  {64078U, 26U},  {64079U, 31U},  {64080U, 33U},
    {62976U, 32U},  {62771U, 1U},   {62259U, 1U},   {62780U, 47U},
    {62268U, 47U}};
static struct stv090x_reg stv0903_initval[99U] = {
    {61724U, 0U},   {61778U, 17U},  {61890U, 72U},  {61891U, 20U},
    {61920U, 39U},  {61921U, 33U},  {61856U, 34U},  {61865U, 192U},
    {61866U, 192U}, {61857U, 0U},   {62484U, 249U}, {62480U, 8U},
    {62494U, 196U}, {62525U, 237U}, {62689U, 130U}, {62527U, 208U},
    {62528U, 184U}, {62544U, 210U}, {62547U, 32U},  {62548U, 0U},
    {62549U, 240U}, {62550U, 112U}, {62836U, 32U},  {62880U, 136U},
    {62882U, 58U},  {62888U, 0U},   {62898U, 16U},  {62872U, 53U},
    {62876U, 193U}, {62529U, 248U}, {62465U, 28U},  {62487U, 32U},
    {62496U, 112U}, {62497U, 136U}, {62508U, 91U},  {62509U, 56U},
    {62520U, 228U}, {62521U, 26U},  {62522U, 9U},   {62526U, 8U},
    {62552U, 193U}, {62553U, 88U},  {62554U, 1U},   {62608U, 38U},
    {62620U, 134U}, {62621U, 134U}, {62720U, 119U}, {62721U, 133U},
    ...
    {62646U, 255U}, {62647U, 204U}, {62648U, 204U}, {62649U, 204U},
    {62650U, 204U}, {62651U, 204U}, {62652U, 204U}, {62653U, 204U},
    {62654U, 204U}, {62655U, 207U}, {64134U, 28U},  {64003U, 55U},
    {64004U, 41U},  {64005U, 55U},  {64006U, 51U},  {64007U, 49U},
    {64008U, 47U},  {64009U, 57U},  {64010U, 58U},  {64011U, 41U},
    {64012U, 55U},  {64013U, 51U},  {64014U, 47U},  {64015U, 57U},
    {64016U, 58U},  {64063U, 4U},   {64067U, 12U},  {64068U, 15U},
    ...
    {64073U, 32U},  {64074U, 33U},  {64075U, 13U},  {64076U, 15U},
    {64077U, 19U},  {64078U, 26U},  {64079U, 31U},  {64080U, 33U},
    {62976U, 32U},  {62771U, 1U},   {62780U, 47U}};
static struct stv090x_reg stv0900_cut20_val[32U] = {
    {61982U, 232U}, {61983U, 16U}, {62013U, 56U}, {62014U, 32U}, {62040U, 90U},
    {62208U, 6U},   {62209U, 0U},  {62210U, 4U},  {61953U, 12U}, {62494U, 232U},
    {62495U, 16U},  {62525U, 56U}, {62526U, 32U}, {62552U, 90U}, {62720U, 6U},
    {62721U, 0U},   {62722U, 4U},  {62465U, 12U}, {64067U, 33U}, {64068U, 33U},
    {64069U, 32U},  {64070U, 31U}, {64071U, 30U}, {64072U, 30U}, {64073U, 29U},
    {64074U, 27U},  {64075U, 32U}, {64076U, 32U}, {64077U, 32U}, {64078U, 32U},
    {64079U, 32U},  {64080U, 33U}};
static struct stv090x_reg stv0903_cut20_val[23U] = {
    {62494U, 232U}, {62495U, 16U}, {62525U, 56U}, {62526U, 32U}, {62552U, 90U},
    {62720U, 6U},   {62721U, 0U},  {62722U, 4U},  {62465U, 12U}, {64067U, 33U},
    {64068U, 33U},  {64069U, 32U}, {64070U, 31U}, {64071U, 30U}, {64072U, 30U},
    {64073U, 29U},  {64074U, 27U}, {64075U, 32U}, {64076U, 32U}, {64077U, 32U},
    {64078U, 32U},  {64079U, 32U}, {64080U, 33U}};
...
static struct stv090x_long_frame_crloop stv090x_s2_lowqpsk_crl_cut20[3U] = {
    {1, 15U, 63U, 14U, 63U, 45U, 47U, 45U, 31U, 61U, 62U},
    {2, 15U, 63U, 14U, 63U, 45U, 47U, 61U, 15U, 61U, 46U},
    {3, 31U, 63U, 30U, 63U, 61U, 31U, 61U, 62U, 61U, 46U}};
static struct stv090x_long_frame_crloop stv090x_s2_lowqpsk_crl_cut30[3U] = {
    {1, 12U, 60U, 11U, 60U, 42U, 44U, 42U, 28U, 58U, 59U},
    {2, 12U, 60U, 11U, 60U, 42U, 44U, 58U, 12U, 58U, 43U},
    {3, 28U, 60U, 27U, 60U, 58U, 28U, 58U, 59U, 58U, 43U}};
static struct stv090x_short_frame_crloop stv090x_s2_short_crl_cut20[4U] = {
    {0, 47U, 46U, 14U, 14U, 61U},
    {1, 62U, 14U, 45U, 13U, 60U},
    {2, 30U, 30U, 30U, 61U, 45U},
    {3, 30U, 30U, 30U, 61U, 45U}};
static struct stv090x_short_frame_crloop stv090x_s2_short_crl_cut30[4U] = {
    {0, 44U, 43U, 11U, 11U, 58U},
      ...
      if (ret != -512) {
        if (verbose != 0U && verbose != 0U) {
          printk("\v%s: Read error, Reg=[0x%02x], Status=%d\n",
                 "stv090x_read_reg", reg, ret);
        } else if (verbose > 1U && verbose != 0U) {
          printk("\r%s: Read error, Reg=[0x%02x], Status=%d\n",
                 "stv090x_read_reg", reg, ret);
        } else if (verbose > 2U && verbose != 0U) {
          printk("\016%s: Read error, Reg=[0x%02x], Status=%d\n",
                 "stv090x_read_reg", reg, ret);
        } else if (verbose > 3U && verbose != 0U) {
      ...
      if (ret != -512) {
        if (verbose != 0U && verbose != 0U) {
          printk("\v%s: Reg=[0x%04x], Data=[0x%02x ...], Count=%u, Status=%d\n",
                 "stv090x_write_regs", reg, (int)*data, count, ret);
        } else if (verbose > 1U && verbose != 0U) {
          printk("\r%s: Reg=[0x%04x], Data=[0x%02x ...], Count=%u, Status=%d\n",
                 "stv090x_write_regs", reg, (int)*data, count, ret);
        } else if (verbose > 2U && verbose != 0U) {
          printk(
              "\016%s: Reg=[0x%04x], Data=[0x%02x ...], Count=%u, Status=%d\n",
              "stv090x_write_regs", reg, (int)*data, count, ret);
        } else if (verbose > 3U && verbose != 0U) {
          printk(
              "\017%s: Reg=[0x%04x], Data=[0x%02x ...], Count=%u, Status=%d\n",
              "stv090x_write_regs", reg, (int)*data, count, ret);
        } else {
        }
      } else {
...
static int stv090x_i2c_gate_ctrl(struct stv090x_state *state, int enable) {
  ...
  {
    if (enable != 0) {
      if ((unsigned long)(state->config)->tuner_i2c_lock !=
          (unsigned long)((void (*)(struct dvb_frontend *, int))0)) {
    ...
    if (enable != 0) {
      ...
      } else if (verbose > 1U && verbose > 3U) {
        printk("\r%s: Enable Gate\n", "stv090x_i2c_gate_ctrl");
      } else if (verbose > 2U && verbose > 3U) {
        printk("\016%s: Enable Gate\n", "stv090x_i2c_gate_ctrl");
      } else if (verbose > 3U && verbose > 3U) {
...
static void stv090x_get_lock_tmg(struct stv090x_state *state) {
  {
    ...
    default:;
      ...
      } else if (state->srate <= 2000000U) {
        state->DemodTimeout = 2500;
        state->FecTimeout = 1100;
      } else if (state->srate <= 5000000U) {
        state->DemodTimeout = 1000;
        state->FecTimeout = 550;
      } else if (state->srate <= 10000000U) {
        state->DemodTimeout = 700;
        state->FecTimeout = 250;
      } else if (state->srate <= 20000000U) {
...
static int stv090x_dvbs_track_crl(struct stv090x_state *state) {
  ...
  int tmp___22;
  {
    if ((state->internal)->dev_ver > 47U) {
      ...
      } else if (state->srate > 6999999U && state->srate <= 14999999U) {
        if ((unsigned int)state->demod == 2U) {
...
static int stv090x_start_search(struct stv090x_state *state) {
  ...
  int tmp___121;
  {
    ...
    if ((state->internal)->dev_ver <= 32U) {
      ...
      } else if ((unsigned int)state->demod == 2U) {
      ...
      if ((unsigned int)state->demod == 2U) {
        tmp___29 =
            stv090x_write_reg(state, 62018U, (int)((u8)((int)freq >> 8)));
        tmp___31 = tmp___29 < 0;
      } else {
        tmp___30 =
            stv090x_write_reg(state, 62530U, (int)((u8)((int)freq >> 8)));
        tmp___31 = tmp___30 < 0;
      }
      if (tmp___31) {
        goto err;
      ...
      if ((unsigned int)state->demod == 2U) {
        tmp___35 =
            stv090x_write_reg(state, 62022U, (int)((u8)((int)freq >> 8)));
        tmp___37 = tmp___35 < 0;
      } else {
        tmp___36 =
            stv090x_write_reg(state, 62534U, (int)((u8)((int)freq >> 8)));
        tmp___37 = tmp___36 < 0;
      }
      if (tmp___37) {
        goto err;
    ...
    if ((state->internal)->dev_ver > 31U) {
      ...
      if (((unsigned int)state->search_mode == 1U ||
           (unsigned int)state->search_mode == 0U) ||
          (unsigned int)state->search_mode == 3U) {
        if ((unsigned int)state->demod == 2U) {
...
static u32 stv090x_srate_srch_coarse(struct stv090x_state *state) {
  ...
  int tmp___86;
  {
    ...
    } else if ((state->internal)->dev_ver > 31U) {
      if ((unsigned int)state->demod == 2U) {
  ...
  ldv_24406:;
    ...
    cur_step = cur_step + 1;
    dir = -dir;
    if (((tmg_cpt > 4 && agc2 < agc2th) && srate_coarse <= 49999999U) &&
        srate_coarse > 850000U) {
      tmg_lock = 1;
      ...
      if ((unsigned long)(state->config)->tuner_set_frequency !=
          (unsigned long)((int (*)(struct dvb_frontend *, u32))0)) {
      ...
      if ((unsigned long)(state->config)->tuner_set_bandwidth !=
          (unsigned long)((int (*)(struct dvb_frontend *, u32))0)) {
        tmp___82 =
            (*((state->config)->tuner_set_bandwidth))(fe, (u32)state->tuner_bw);
        if (tmp___82 < 0) {
          goto err_gateoff;
        } else {
        }
      ...
      if ((unsigned long)(state->config)->tuner_get_status !=
          (unsigned long)((int (*)(struct dvb_frontend *, u32 *))0)) {
  ...
  int tmp___82;
  {
    ...
    if (state->srate > sym) {
      ...
      if (srate_coarse > 3000000U) {
        ...
        if ((unsigned int)state->demod == 2U) {
          tmp___35 =
              stv090x_write_reg(state, 62048U, (int)((u8)(sym >> 8)) & 127);
          tmp___37 = tmp___35 < 0;
        } else {
          tmp___36 =
              stv090x_write_reg(state, 62560U, (int)((u8)(sym >> 8)) & 127);
          tmp___37 = tmp___36 < 0;
        }
        if (tmp___37) {
          goto err;
        ...
        if ((unsigned int)state->demod == 2U) {
          tmp___41 =
              stv090x_write_reg(state, 62050U, (int)((u8)(sym >> 8)) & 127);
          tmp___43 = tmp___41 < 0;
        } else {
          tmp___42 =
              stv090x_write_reg(state, 62562U, (int)((u8)(sym >> 8)) & 127);
          tmp___43 = tmp___42 < 0;
        }
        if (tmp___43) {
          goto err;
      ...
      if ((unsigned int)state->demod == 2U) {
        tmp___74 =
            stv090x_write_reg(state, 62024U, (int)((u8)(freq_coarse >> 8)));
        tmp___76 = tmp___74 < 0;
      } else {
        tmp___75 =
            stv090x_write_reg(state, 62536U, (int)((u8)(freq_coarse >> 8)));
        tmp___76 = tmp___75 < 0;
      }
      if (tmp___76) {
        goto err;
    ...
    if (lock == 0) {
      if (state->srate > 9999999U) {
        ...
        ldv_24492:;
          ...
          if ((unsigned long)(state->config)->tuner_set_bandwidth !=
              (unsigned long)((int (*)(struct dvb_frontend *, u32))0)) {
            tmp___9 = (*((state->config)->tuner_set_bandwidth))(
                fe, (u32)state->tuner_bw);
            if (tmp___9 < 0) {
              goto err_gateoff;
            } else {
            }
...
static int stv090x_search_car_loop(struct stv090x_state *state, s32 inc,
  ...
  ldv_24534:;
    ...
    if ((((lock == 0 && no_signal == 0) && offst_freq - inc < car_max) &&
         offst_freq + inc > -car_max) &&
        cpt_step < steps_max) {
      goto ldv_24534;
    } else {
...
static enum stv090x_signal_state
stv090x_get_sig_params(struct stv090x_state *state) {
  struct dvb_frontend *fe;
  u8 tmg;
  u32 reg;
  s32 i;
  ...
  int __x___4;
  {
    ...
    if ((unsigned long)(state->config)->tuner_get_frequency !=
        (unsigned long)((int (*)(struct dvb_frontend *, u32 *))0)) {
      tmp___4 =
...
static u8 stv090x_optimize_carloop(struct stv090x_state *state,
  ...
  struct stv090x_long_frame_crloop *car_loop_apsk_low;
  {
    ...
    ldv_24628:;
      if (i <= 2 &&
          (unsigned int)(car_loop_qpsk_low + (unsigned long)i)->modcod !=
              (unsigned int)modcod) {
        goto ldv_24627;
      } else {
      }
    ...
    ldv_24630:
      i = i + 1;
    ldv_24631:;
      if (i <= 13 && (unsigned int)(car_loop + (unsigned long)i)->modcod !=
                         (unsigned int)modcod) {
        goto ldv_24630;
      } else {
      }
      ...
      ldv_24634:;
        if (i <= 10 &&
            (unsigned int)(car_loop_apsk_low + (unsigned long)i)->modcod !=
                (unsigned int)modcod) {
          goto ldv_24633;
        } else {
        }
    ...
    } else if ((unsigned int)modcod <= 17U) {
      if (pilots != 0) {
        if (state->srate <= 3000000U) {
...
static int stv090x_optimize_track(struct stv090x_state *state) {
  ...
  int tmp___162;
  {
    ...
    case 2U:;
      ...
      if ((unsigned int)state->frame_len == 0U) {
        ...
        } else if ((unsigned int)state->modulation == 1U) {
          if ((unsigned int)state->demod == 2U) {
        ...
        } else if ((unsigned int)state->modulation == 2U) {
          if ((unsigned int)state->demod == 2U) {
        ...
        } else if ((unsigned int)state->modulation == 3U) {
          if ((unsigned int)state->demod == 2U) {
  ...
  ldv_24664:;
    ...
    if (((state->internal)->dev_ver > 31U || blind_tune == 1) ||
      ...
      if ((state->internal)->dev_ver > 31U || blind_tune == 1) {
        if ((unsigned int)state->algo != 2U) {
          ...
          if ((unsigned long)(state->config)->tuner_set_bandwidth !=
              (unsigned long)((int (*)(struct dvb_frontend *, u32))0)) {
            tmp___132 = (*((state->config)->tuner_set_bandwidth))(
                fe, (u32)state->tuner_bw);
            if (tmp___132 < 0) {
              goto err_gateoff;
            } else {
    ...
    if ((unsigned int)state->delsys == 1U ||
        (unsigned int)state->delsys == 3U) {
  ...
  int tmp___111;
  {
    ...
    if ((unsigned int)state->algo == 0U) {
      ...
      if ((state->internal)->dev_ver > 31U) {
        ...
        } else if ((unsigned int)state->algo == 2U) {
      ...
      tmp___45 = stv090x_set_max_srate(state, (u32)(state->internal)->mclk,
                                       state->srate);
      if (tmp___45 < 0) {
        goto err;
      } else {
      }
      tmp___46 = stv090x_set_min_srate(state, (u32)(state->internal)->mclk,
                                       state->srate);
      if (tmp___46 < 0) {
        goto err;
      } else {
    ...
    if ((unsigned long)(state->config)->tuner_set_bbgain !=
        (unsigned long)((int (*)(struct dvb_frontend *, u32))0)) {
    ...
    } else if ((unsigned int)state->algo == 1U) {
...
static int stv090x_table_lookup(struct stv090x_tab const *tab, int max,
                                int val) {
  int res;
  int min;
  int med;
  {
    ...
    if (((int)(tab + (unsigned long)min)->read <= val &&
         (int)(tab + (unsigned long)max)->read > val) ||
        ((int)(tab + (unsigned long)max)->read <= val &&
         (int)(tab + (unsigned long)min)->read > val)) {
      goto ldv_24779;
    ldv_24778:
      med = (max + min) / 2;
      if (((int)(tab + (unsigned long)min)->read <= val &&
           (int)(tab + (unsigned long)med)->read > val) ||
          ((int)(tab + (unsigned long)med)->read <= val &&
           (int)(tab + (unsigned long)min)->read > val)) {
        max = med;
      } else {
    ...
    ldv_24779:;
      ...
      res = ((val - (int)(tab + (unsigned long)min)->read) *
             ((int)(tab + (unsigned long)max)->real -
              (int)(tab + (unsigned long)min)->real)) /
                ((int)(tab + (unsigned long)max)->read -
                 (int)(tab + (unsigned long)min)->read) +
            (int)(tab + (unsigned long)min)->real;
    } else if ((int)(tab + (unsigned long)min)->read <
               (int)(tab + (unsigned long)max)->read) {
      if ((int)(tab + (unsigned long)min)->read > val) {
        res = (tab + (unsigned long)min)->real;
      } else if ((int)(tab + (unsigned long)max)->read <= val) {
        res = (tab + (unsigned long)max)->real;
      } else {
      }
    } else if ((int)(tab + (unsigned long)min)->read <= val) {
      res = (tab + (unsigned long)min)->real;
    } else if ((int)(tab + (unsigned long)max)->read > val) {
      res = (tab + (unsigned long)max)->real;
    } else {
...
static int stv090x_read_signal_strength(struct dvb_frontend *fe,
  ...
  int tmp___4;
  {
    ...
    agc_0 = (s32)reg & 255;
    agc = (agc_1 << 8) | agc_0;
    str = stv090x_table_lookup((struct stv090x_tab const *)(&stv090x_rf_tab),
                               13, agc);
    if ((int)stv090x_rf_tab[0].read < agc) {
      str = 0;
    } else if ((int)stv090x_rf_tab[13UL].read > agc) {
      str = -100;
    } else {
    }
...
static int stv090x_send_diseqc_msg(struct dvb_frontend *fe,
  ...
  int tmp___25;
  {
    ...
    reg = (u32)tmp___1;
    reg = (reg & 4294967288U) |
          ((int)(state->config)->diseqc_envelope_mode ? 4U : 2U);
    reg = reg | 64U;
    if ((unsigned int)state->demod == 2U) {
      tmp___2 = stv090x_write_reg(state, 61840U, (int)((u8)reg));
      tmp___4 = tmp___2 < 0;
...
static int stv090x_sleep(struct dvb_frontend *fe) {
  ...
  int tmp___21;
  {
    ...
    if ((unsigned long)(state->config)->tuner_sleep !=
        (unsigned long)((int (*)(struct dvb_frontend *))0)) {
    ...
    if (verbose != 0U && verbose > 3U) {
      printk("\v%s: Set %s(%d) to sleep\n", "stv090x_sleep",
             (unsigned int)state->device == 1U ? (char *)"STV0900"
                                               : (char *)"STV0903",
...
static int stv0900_set_tspath(struct stv090x_state *state) {
  ...
  ldv_25000:;
    if ((unsigned int)(state->config)->ts1_clk != 0U) {
      ...
      case 4:;
      default:
        speed = (unsigned int)(state->internal)->mclk /
                ((unsigned int)(state->config)->ts1_clk / 4U);
        if (speed <= 7U) {
          speed = 8U;
        } else {
        }
      ...
      case 2:
        speed = (unsigned int)(state->internal)->mclk /
                ((unsigned int)(state->config)->ts1_clk / 32U);
        if (speed <= 31U) {
          speed = 32U;
        } else {
        }
    ...
    if ((unsigned int)(state->config)->ts2_clk != 0U) {
      ...
      case 4:;
      default:
        speed___0 = (unsigned int)(state->internal)->mclk /
                    ((unsigned int)(state->config)->ts2_clk / 4U);
        if (speed___0 <= 7U) {
          speed___0 = 8U;
        } else {
        }
      ...
      case 2:
        speed___0 = (unsigned int)(state->internal)->mclk /
                    ((unsigned int)(state->config)->ts2_clk / 32U);
        if (speed___0 <= 31U) {
          speed___0 = 32U;
        } else {
        }
...
static int stv090x_init(struct dvb_frontend *fe) {
  ...
  int tmp___22;
  {
    ...
    if ((state->internal)->mclk == 0) {
      ...
      if ((unsigned long)config->tuner_init !=
          (unsigned long)((int (*)(struct dvb_frontend *))0)) {
      ...
      tmp___2 = stv090x_write_reg(
          state, 61878U, (int)((unsigned int)((u8)config->clk_mode) | 32U));
      if (tmp___2 < 0) {
        goto err;
      } else {
      }
    ...
    if ((unsigned long)config->tuner_set_mode !=
        (unsigned long)((int (*)(struct dvb_frontend *, enum tuner_mode))0)) {
...
static int stv090x_setup(struct dvb_frontend *fe) {
  ...
  int tmp___17;
  {
    ...
    if ((unsigned int)state->device == 1U) {
      ...
      t2_size = 32UL;
    } else if ((unsigned int)state->device == 0U) {
      if (verbose != 0U && verbose > 3U) {
    ...
    goto ldv_25082;
  ldv_25081:
    tmp___8 = stv090x_write_reg(
        state, (unsigned int)(stv090x_initval + (unsigned long)i)->addr,
  ...
  ldv_25082:;
    ...
    if ((state->internal)->dev_ver > 31U) {
      ...
      goto ldv_25085;
    ldv_25084:
      tmp___11 = stv090x_write_reg(
          state, (unsigned int)(stv090x_cut20_val + (unsigned long)i)->addr,
    ...
    ldv_25085:;
      ...
      goto err;
    } else if ((state->internal)->dev_ver > 48U) {
      if (verbose != 0U && verbose != 0U) {
    ...
    reg = (u32)tmp___12;
    reg = (reg & 4294967294U) |
          (unsigned int)((unsigned int)config->adc1_range != 1U);
    ...
    reg = (u32)tmp___14;
    reg = (reg & 4294967294U) |
          (unsigned int)((unsigned int)config->adc2_range != 1U);
...
int stv090x_set_gpio(struct dvb_frontend *fe, u8 gpio, u8 dir, u8 value,
  ...
  int tmp;
  {
    state = (struct stv090x_state *)fe->demodulator_priv;
    reg = 0U;
    reg = (u8)(((int)((signed char)reg) & 127) |
               (int)((signed char)((int)dir << 7)));
    reg = (u8)(((int)((signed char)reg) & -127) |
               (int)((signed char)((int)value << 1)));
...
struct dvb_frontend *stv090x_attach(struct stv090x_config const *config,
  ...
  int tmp___1;
  {
    ...
    if ((unsigned long)temp_int != (unsigned long)((struct stv090x_dev *)0) &&
      ...
      if ((unsigned long)state->internal ==
          (unsigned long)((struct stv090x_internal *)0)) {
        goto error;
      } else {
      }
      ...
      __mutex_init(&(state->internal)->demod_lock,
                   "&state->internal->demod_lock", &__key);
      __mutex_init(&(state->internal)->tuner_lock,
                   "&state->internal->tuner_lock", &__key___0);
    ...
    if ((state->internal)->dev_ver > 47U) {
      state->frontend.ops.info.caps =
          (fe_caps_t)((unsigned int)state->frontend.ops.info.caps | 67108864U);
    } else {
    }
...
int main(void) {
  ...
  ldv_25172:
    ...
    case 5:
      ldv_handler_precall();
      stv090x_send_diseqc_burst(var_group1,
                                var_stv090x_send_diseqc_burst_57_p1);
      goto ldv_25158;
    case 6:
      ldv_handler_precall();
    ...
    case 11:
      ldv_handler_precall();
      stv090x_read_signal_strength(var_group1,
                                   var_stv090x_read_signal_strength_52_p1);
      goto ldv_25158;
    case 12:
      ldv_handler_precall();
...
int ldv_mutex_lock_interruptible_demod_lock_of_stv090x_internal(
    struct mutex *lock) {
  int nondetermined;
  {
...
int ldv_mutex_trylock_demod_lock_of_stv090x_internal(struct mutex *lock) {
  int is_mutex_held_by_another_thread;
  {
    ...
    is_mutex_held_by_another_thread = symbols[5];
...
int ldv_atomic_dec_and_mutex_lock_demod_lock_of_stv090x_internal(
    atomic_t *cnt, struct mutex *lock) {
  int atomic_value_after_dec;
  {
    ...
    atomic_value_after_dec = symbols[6];
...
int ldv_mutex_trylock_lock(struct mutex *lock) {
  int is_mutex_held_by_another_thread;
  {
    ...
    is_mutex_held_by_another_thread = symbols[10];
    if (is_mutex_held_by_another_thread) {
      return (0);
    } else {
      ldv_mutex_lock = 2;
...
int ldv_atomic_dec_and_mutex_lock_lock(atomic_t *cnt, struct mutex *lock) {
  int atomic_value_after_dec;
  {
    ...
    atomic_value_after_dec = symbols[11];
    if (atomic_value_after_dec == 0) {
      ldv_mutex_lock = 2;
      return (1);
    } else {
...
int ldv_mutex_trylock_mutex_of_device(struct mutex *lock) {
  int is_mutex_held_by_another_thread;
  {
    ...
    is_mutex_held_by_another_thread = symbols[15];
    if (is_mutex_held_by_another_thread) {
      return (0);
    } else {
      ldv_mutex_mutex_of_device = 2;
...
int ldv_atomic_dec_and_mutex_lock_mutex_of_device(atomic_t *cnt,
                                                  struct mutex *lock) {
  int atomic_value_after_dec;
  {
    if (ldv_mutex_mutex_of_device == 1) {
    ...
    atomic_value_after_dec = symbols[16];
    if (atomic_value_after_dec == 0) {
      ldv_mutex_mutex_of_device = 2;
      return (1);
    } else {
...
int ldv_mutex_lock_interruptible_tuner_lock_of_stv090x_internal(
    struct mutex *lock) {
  int nondetermined;
  {
...
int ldv_mutex_trylock_tuner_lock_of_stv090x_internal(struct mutex *lock) {
  int is_mutex_held_by_another_thread;
  {
    ...
    is_mutex_held_by_another_thread = symbols[20];
    if (is_mutex_held_by_another_thread) {
      return (0);
    } else {
      ldv_mutex_tuner_lock_of_stv090x_internal = 2;
...
int ldv_atomic_dec_and_mutex_lock_tuner_lock_of_stv090x_internal(
    atomic_t *cnt, struct mutex *lock) {
  int atomic_value_after_dec;
  {
    if (ldv_mutex_tuner_lock_of_stv090x_internal == 1) {
    ...
    atomic_value_after_dec = symbols[21];
    if (atomic_value_after_dec == 0) {
      ldv_mutex_tuner_lock_of_stv090x_internal = 2;
      return (1);
    } else {
...
void __mutex_init(struct mutex *arg0, const char *arg1,
                  struct lock_class_key *arg2) {
  return;
}
...
void ldv_handler_precall() { return; }
void msleep(unsigned int arg0) { return; }
void mutex_lock(struct mutex *arg0) { return; }
int __VERIFIER_nondet_int(void);
int mutex_trylock(struct mutex *arg0) { return symbols[24]; }
void mutex_unlock(struct mutex *arg0) { return; }
int __VERIFIER_nondet_int(void);
int printk(const char *arg0, ...) { return symbols[25]; }
void free(void *);
void kfree(void const *p) { free((void *)p); }
